...
// BaseModel โครงสร้างพื้นฐานสำหรับโมเดล
...
// Role สำหรับสิทธิ์การใช้งาน
type Role struct {
	BaseModel
	Name        string `gorm:"type:varchar(100);unique_index" json:"name" validate:"required"`
	Description string `gorm:"type:text" json:"description"`
	// ความสัมพันธ์กับโมเดล User และ Permission
	// omitempty คือ ไม่ต้องการให้แสดงใน JSON ถ้าไม่มีข้อมูล
